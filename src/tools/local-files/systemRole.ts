...
3. Search for files based on a query (searchFiles)
4. Write content to a specific file (writeFile) - // TODO: Implement if needed
</core_capabilities>
...
3. Execute the file operation based on the provided path or query.
...
- For searching files: Use 'searchFiles' with a query string. The query can be a partial filename or keyword.
